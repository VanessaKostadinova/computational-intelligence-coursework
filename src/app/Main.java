...
/* A simple example of how the app.CarPricePrediction class could be used as part
 ...
 * validation) to, respectively, obtain a promising set of parameters (using
 * train) and then to measure their performance (using validation).]
 */
public class Main {
    public static void main(String[] args) throws IOException {
        var training_problem = new CarPricePrediction("train");
        ...
        var validation_problem  = new CarPricePrediction("validation");
        var validation_error = validation_problem.evaluate(best_parameters);
